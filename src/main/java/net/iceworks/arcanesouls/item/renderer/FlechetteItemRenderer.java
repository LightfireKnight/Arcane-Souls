package net.iceworks.arcanesouls.item.renderer;
...
import net.iceworks.arcanesouls.item.model.FlechetteItemModel;
import net.iceworks.arcanesouls.item.FlechetteItem;
import net.iceworks.arcanesouls.interfaces.RendersPlayerArms;
...
public class FlechetteItemRenderer extends GeoItemRenderer<FlechetteItem> implements RendersPlayerArms {
	public FlechetteItemRenderer() {
		super(new FlechetteItemModel());
	}

	@Override
	public RenderType getRenderType(FlechetteItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof FlechetteItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new FlechetteItemRenderer();
	...
	protected FlechetteItem animatable;
	...
	@Override
	public void render(GeoModel model, FlechetteItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public void render(FlechetteItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public ResourceLocation getTextureLocation(FlechetteItem instance) {
		return super.getTextureLocation(instance);
	}

	@Override
	public Integer getUniqueID(FlechetteItem animatable) {
