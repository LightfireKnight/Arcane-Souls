...
import net.iceworks.arcanesouls.item.model.ThornItemModel;
...
public class ThornItemRenderer extends GeoItemRenderer<ThornItem> implements RendersPlayerArms {
	public ThornItemRenderer() {
		super(new ThornItemModel());
	}

	@Override
	public RenderType getRenderType(ThornItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof ThornItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new ThornItemRenderer();
	...
	protected ThornItem animatable;
	...
	@Override
	public void render(GeoModel model, ThornItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public void render(ThornItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public ResourceLocation getTextureLocation(ThornItem instance) {
		return super.getTextureLocation(instance);
	}

	@Override
	public Integer getUniqueID(ThornItem animatable) {
