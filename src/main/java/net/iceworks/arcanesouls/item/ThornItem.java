...
import net.iceworks.arcanesouls.procedures.ThornRightclickedProcedure;
import net.iceworks.arcanesouls.item.renderer.ThornItemRenderer;
...
public class ThornItem extends Item implements IAnimatable {
	...
	public void initializeClient(Consumer<IClientItemExtensions> consumer) {
		...
		consumer.accept(new IClientItemExtensions() {
			private final BlockEntityWithoutLevelRenderer renderer = new ThornItemRenderer();
	...
	protected void interpretFirstPersonInstructions(List<String> tokens, ThornItemRenderer renderer) {
	...
	public void setupAnimationState(ThornItemRenderer renderer, ItemStack stack, PoseStack matrixStack, float aimProgress) {
	}
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		ThornRightclickedProcedure.execute(world, x, y, z, entity, itemstack);
		return ar;
	}
}
