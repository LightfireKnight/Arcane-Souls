...
import net.iceworks.arcanesouls.procedures.FlechetteRightclickedProcedure;
import net.iceworks.arcanesouls.item.renderer.FlechetteItemRenderer;
...
public class FlechetteItem extends Item implements IAnimatable {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	public String animationprocedure = "empty";
	public static ItemTransforms.TransformType transformType;

	public FlechetteItem() {
	...
	public void initializeClient(Consumer<IClientItemExtensions> consumer) {
		...
		consumer.accept(new IClientItemExtensions() {
			private final BlockEntityWithoutLevelRenderer renderer = new FlechetteItemRenderer();
	...
	protected void interpretFirstPersonInstructions(List<String> tokens, FlechetteItemRenderer renderer) {
	...
	private <P extends Item & IAnimatable> PlayState idlePredicate(AnimationEvent<P> event) {
		if (this.transformType != null ? true : false) {
			if (this.animationprocedure.equals("empty")) {
				event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.ThornGun.idle", EDefaultLoopTypes.LOOP));
	...
	public void setupAnimationState(FlechetteItemRenderer renderer, ItemStack stack, PoseStack matrixStack, float aimProgress) {
	}
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		FlechetteRightclickedProcedure.execute(entity, itemstack);
		return ar;
	}
}
