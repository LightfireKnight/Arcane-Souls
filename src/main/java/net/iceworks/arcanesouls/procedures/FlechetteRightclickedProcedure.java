...
public class FlechetteRightclickedProcedure {
			...
			if (!projectileLevel.isClientSide()) {
				Projectile _entityToSpawn = new Object() {
					public Projectile getArrow(Level level, Entity shooter, float damage, int knockback) {
						AbstractArrow entityToSpawn = new FlechetteProjectileEntity(ArcaneSoulsModEntities.FLECHETTE_PROJECTILE.get(), level);
